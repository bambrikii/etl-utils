                ...
                .forEach(mappingModel -> {
                    ...
                    mappingModel
                            ...
                            .forEach(mappingField -> {
                                EtlFieldExtractable fieldReader = EtlAdapterUtils.createFieldReader(sourceModelFieldConfig, targetModelFieldConfig, mappingField, etlFieldReaderStrategy);
                                EtlFieldLoadable fieldWriter = EtlAdapterUtils.createFieldWriter(sourceModelFieldConfig, targetModelFieldConfig, mappingField, etlFieldWriterStrategy);
